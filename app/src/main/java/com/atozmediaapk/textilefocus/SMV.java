...
public class SMV extends AppCompatActivity {
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Observe Time");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Rating Of the Operator");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){

                    edit3.setError("Please Enter Machine Allowance");
                    edit3.requestFocus();
                    return;
                }
                ...
                if(string4.equals("")){
                    ...
                    edit4.setError("Please Enter Other Allowance");
                    edit4.requestFocus();
                    return;
                }
                ...
                float btn_calculation2=btn_calculation1/100;
                float btn_calculation3=edt3+edt4;
                float btn_calculation4=btn_calculation2*btn_calculation3;
                float btn_calculation5=btn_calculation4/100;
                float btn_calculation6=btn_calculation2+btn_calculation5;
