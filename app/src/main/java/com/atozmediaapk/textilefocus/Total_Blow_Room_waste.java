...
public class Total_Blow_Room_waste extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_total_blow_room_waste);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter input in kgs");
                    edit2.requestFocus();
                    return;
                }
