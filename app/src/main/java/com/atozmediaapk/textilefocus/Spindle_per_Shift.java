...
public class Spindle_per_Shift extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_spindle_per_shift);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Count");
                    edit2.requestFocus();
                    return;
                }
                ...
                float btn_calcultion1=edt2*60;


                tex1.setText(Float.toString((float) ((double) (edt1*btn_calcultion1))));
