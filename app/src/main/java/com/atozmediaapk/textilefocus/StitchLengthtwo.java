...
public class StitchLengthtwo extends AppCompatActivity {

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_stitch_lengthtwo);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Yarn Length");
                    edit1.requestFocus();
                    return;
                }
                if(string2.equals("")){

                    edit2.setError("Number of stitch");
                    edit2.requestFocus();
                    return;
                }
