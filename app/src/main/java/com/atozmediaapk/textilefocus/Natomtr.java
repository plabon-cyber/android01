...
public class Natomtr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_natomtr);
       ...
       /* MobileAds.initialize(this, new OnInitializationCompleteListener() {
        ...
        final EditText edit1,edit2,edit3,edit4,edit5,NAID;
        final EditText be;
        Button BTN, btnRest;
        ...
        BTN.setOnClickListener(v -> {
            ...
            String string6=NAID.getText().toString();
            ...
            if(string6.equals("")){
                ...
                NAID.setError("Please Enter Caustic Kg");
                NAID.requestFocus();
                return;
            }
            ...
            float edt6 = Float.parseFloat(NAID.getText().toString());
            ...
            double btn_calculation4 = btn_calculation3*25.64;
            double btn_calculation5 = btn_calculation4*edt5;
            float btn_calculation6 = (float) (btn_calculation5/39.37);
            float btn_calculation7= edt6*1000/btn_calculation6*1000/calculation1;
            float btn_calculation8= edt6*1000/btn_calculation6*1000/calculation26;
            tex1.setText(Float.toString(btn_calculation7));
