...
public class Production_card extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_production_card);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Doffer Dia (inch)");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Doffer Speed");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){

                    edit3.setError("Please Enter Hank Sliver Delivered");
                    edit3.requestFocus();
                    return;
                }
                ...
                double btn_calculation1 =  edt1*edt2*3.14*60*8;
                double btn_calculation2= edt3*36*840*2.204;
