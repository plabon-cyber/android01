...
public class walseperinch extends AppCompatActivity {

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_walseperinch);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double btn_calculation1 =  edt1*3.14159265;
                double btn_calculation2 =  btn_calculation1/edt2;
                double btn_calculation3 =  btn_calculation2*25.4;
