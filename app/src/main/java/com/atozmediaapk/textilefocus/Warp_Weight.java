...
public class Warp_Weight extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_warp_weight);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Cripm%");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){
                ...
                float btn_calculation1= (float) (edt1*1.0936*453.59*edt2);
                float btn_calculation2=840*edt3;
                float btn_calculation3=btn_calculation1/btn_calculation2;
                float btn_calculation4=btn_calculation3*edt4;
