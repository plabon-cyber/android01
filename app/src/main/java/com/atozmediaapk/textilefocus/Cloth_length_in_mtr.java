...
public class Cloth_length_in_mtr extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cloth_length_in_mtr);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter weft weight in kgs");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter weft count");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){
                ...
                if(string4.equals("")){
                    ...
                    edit4.setError("Please Enter R.S in inches");
                    edit4.requestFocus();
                    return;
                }
                ...
                float btn_calculation1= (float) (edt1*edt2*1848*0.9144);
