...
public class SpeedFrameProduction extends AppCompatActivity {
    ...
    String [] listviewitems2=new String[]{"1. Production In Kg per Shift"};
    String [] listviewitems3=new String[]{"2. Twist Per Inch"};
    String [] listviewitems4=new String[]{"3. Twist Multiplier"};
    String [] listviewitems5=new String[]{"4. Production/Spindle/Shift in kgs at 100% Efficiency"};
    String [] listviewitems6=new String[]{"5. Grams/Spindle/Shift of Eight Hours"};
    String [] listviewitems7=new String[]{"6. Expected Hanks per shift of 8 hrs"};
    String [] listviewitems8=new String[]{"7. Efficiency"};
    String [] listviewitems9=new String[]{"8. Front Roller Surface Speed"};
    String [] listviewitems10=new String[]{"9. Spindle Speed"};
    String [] listviewitems11=new String[]{"10. Hank Delivered"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_speed_frame_production);
        ...
        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent2=new Intent(SpeedFrameProduction.this,Speedframpro.class);
        ...
        listView3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent3=new Intent(SpeedFrameProduction.this,TPI_SpeedFrame.class);
        ...
        listView4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent4=new Intent(SpeedFrameProduction.this,Twist_Multiplier.class);
        ...
        listView5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent5=new Intent(SpeedFrameProduction.this,Spindle_per_Shift.class);
        ...
        listView6.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent6=new Intent(SpeedFrameProduction.this,Gram_per_Spindle.class);
        ...
        listView7.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent7=new Intent(SpeedFrameProduction.this,ExpectedHank.class);
        ...
        listView8.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent8=new Intent(SpeedFrameProduction.this,Spindle_Efficiency.class);
        ...
        listView9.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent9=new Intent(SpeedFrameProduction.this,Front_Roller_Surface_Speed.class);
        ...
        listView10.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent10=new Intent(SpeedFrameProduction.this,Spindle_Speed.class);
        ...
        listView11.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent11=new Intent(SpeedFrameProduction.this,Spindle_Hank_Delivered.class);
