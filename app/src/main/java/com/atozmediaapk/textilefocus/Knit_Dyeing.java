...
public class Knit_Dyeing extends AppCompatActivity {
    ImageView imageView;
    ...
    String [] listviewitems2=new String[]{"2. Knit Dyeing Process"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knit_dyeing);
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent1=new Intent(Knit_Dyeing.this,CountGsm.class);
        ...
        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent2=new Intent(Knit_Dyeing.this,Knitepdf.class);
        ...
        listView3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent3=new Intent(Knit_Dyeing.this,CausticBaume.class);
        ...
        listView03.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent03=new Intent(Knit_Dyeing.this,Various_Dyeing_Machine.class);
        ...
        listView4.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent4=new Intent(Knit_Dyeing.this,Dyeing_Calculation.class);
        ...
        listView5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent5=new Intent(Knit_Dyeing.this,Dye_Calculation.class);
        ...
        listView6.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent6=new Intent(Knit_Dyeing.this,Auxiliarise.class);
        ...
        listView7.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent7=new Intent(Knit_Dyeing.this,ColorCode.class);
        ...
        listView8.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent8=new Intent(Knit_Dyeing.this,Elengation.class);
