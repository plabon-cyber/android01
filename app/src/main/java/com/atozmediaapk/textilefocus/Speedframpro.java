...
public class Speedframpro extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_speedframpro);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float btn_calculation1= edt1 *60*8*120;
                float btn_calculation2= (float) (edt2*36*840*2.204);
