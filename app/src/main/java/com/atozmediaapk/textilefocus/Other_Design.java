...
public class Other_Design extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_other_design);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Ends");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Repeat");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){

                    edit3.setError("Please Enter Yarn Diametre");
                    edit3.requestFocus();
                    return;
                }
                ...
                if(string4.equals("")){
                    ...
                    edit4.setError("Please Enter no of intersections");
                    edit4.requestFocus();
                    return;
                }
                ...
                float btn_calculation2=1/edt3;
                float btn_calculation3=btn_calculation1*btn_calculation2;
                float btn_calculation4=edt4/edt2;
                float btn_calculation5=edt1/edt2;
                float btn_calculation6=btn_calculation4+btn_calculation5;
                float btn_calculation7=btn_calculation3/btn_calculation6;
