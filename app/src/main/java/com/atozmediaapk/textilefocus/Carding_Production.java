...
public class Carding_Production extends AppCompatActivity {
    ...
    ListView listView2,listView3,listView4,listView5,listView6,listView7,listView8,listView9,listView10,listView11,listView12,listView13,listView14,listView15,listView16;
    String [] listviewitems2=new String[]{"1. Draft"};
    String [] listviewitems3=new String[]{"2. TPI"};
    String [] listviewitems4=new String[]{"3. Production/card/8hrs"};
    String [] listviewitems5=new String[]{"4. Side shaft Change bevel"};
    String [] listviewitems6=new String[]{"5. Nep Count"};
    String [] listviewitems7=new String[]{"6. Standard nep count"};
    String [] listviewitems8=new String[]{"7. Nep/2Grains"};
    String [] listviewitems9=new String[]{"8. Surface speed ratio"};
    String [] listviewitems10=new String[]{"9. Cleaning efficency"};
    String [] listviewitems11=new String[]{"10. Draft Constant"};
    String [] listviewitems12=new String[]{"11. Card doffer speed"};
    String [] listviewitems13=new String[]{"12. Avg.Capacity of card sliver can(Net wt in lb)"};
    String [] listviewitems14=new String[]{"13. Carding Index(k)"};
    String [] listviewitems15=new String[]{"14. Lickerin speed"};
    String [] listviewitems16=new String[]{"15. Actual Draft"};

    @SuppressLint("SourceLockedOrientationActivity")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_carding_production);
      ...
      /*  MobileAds.initialize(this, new OnInitializationCompleteListener() {
        ...
        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent2=new Intent(Carding_Production.this,Draft.class);
        ...
        listView3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent3=new Intent(Carding_Production.this,TPI.class);
        ...
        listView4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent4=new Intent(Carding_Production.this,Production_card.class);
        ...
        listView5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent5=new Intent(Carding_Production.this,Side_shaft.class);
        ...
        listView6.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent6=new Intent(Carding_Production.this,Nep_Count.class);
        ...
        listView7.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent7=new Intent(Carding_Production.this,St_Nep_Count.class);
        ...
        listView8.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent8=new Intent(Carding_Production.this,Nep_per_2grains.class);
        ...
        listView9.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent9=new Intent(Carding_Production.this,Surface_Speed.class);
        ...
        listView10.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent10=new Intent(Carding_Production.this,Cleaning_Efficency_Card.class);
        ...
        listView11.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent11=new Intent(Carding_Production.this,Draft_Constant.class);
        ...
        listView12.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent12=new Intent(Carding_Production.this,Card_Doffer_Speed.class);
        ...
        listView13.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent13=new Intent(Carding_Production.this,Avg_Speed_Card.class);
        ...
        listView14.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent14=new Intent(Carding_Production.this,Carding_Index.class);
        ...
        listView15.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent15=new Intent(Carding_Production.this,Lickerin_speed.class);
        ...
        listView16.setOnItemClickListener((parent, view, position, id) -> {
            String Templistview=listviewitems16[position].toString();
            Intent intent16=new Intent(Carding_Production.this,Actual_Draft.class);
