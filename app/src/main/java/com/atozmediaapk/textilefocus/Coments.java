            ...
            public void onClick(View v) {
                ...
                root.push().setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(Coments.this, "Data Saved", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            storageRef.putFile(imageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(Coments.this, "Image uploaded successfully", Toast.LENGTH_SHORT).show();
                            // Navigate to the display activity and pass image URI
                            Intent intent = new Intent(Coments.this, DisplayImageActivity.class);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Coments.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
        ...
        ApiUtils.getClients().sendNotification(notification).enqueue(new Callback<PushNotification>() {
            ...
            public void onResponse(Call<PushNotification> call, Response<PushNotification> response) {
                if (response.isSuccessful())
                    Toast.makeText(Coments.this,"success",Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(Coments.this,"error",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<PushNotification> call, Throwable t) {
                Toast.makeText(Coments.this,t.getMessage(),Toast.LENGTH_SHORT).show();
