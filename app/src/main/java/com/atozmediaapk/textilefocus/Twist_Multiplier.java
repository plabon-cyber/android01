...
public class Twist_Multiplier extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_twist_multiplier);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter TPI");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Hank or Count");
                    edit2.requestFocus();
                    return;
                }
                ...
                float btn_calculation1= (float) ((float) edt1/sqrt1);
