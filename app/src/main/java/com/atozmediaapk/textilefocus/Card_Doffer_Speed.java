...
public class Card_Doffer_Speed extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_card_doffer_speed);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Cylinder Dia in Inches");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Cylinder RPM");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){

                    edit3.setError("Please Enter Doffer Dia in Inches");
                    edit3.requestFocus();
                    return;
                }
                ...
                if(string4.equals("")){
                    ...
                    edit4.setError("Please Enter Staple Length");
                    edit4.requestFocus();
                    return;
                }
                ...
                float btn_calculation1= (float) (edt1*edt2*0.036);
                float btn_calculation2= (float) (edt3*edt4);
