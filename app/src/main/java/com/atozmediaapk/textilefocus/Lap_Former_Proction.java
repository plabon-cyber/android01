...
public class Lap_Former_Proction extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lap_former_proction);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Delivery Speed");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string3.equals("")){
                    ...
                    edit3.setError("Please Enter Efficiency %");
                    edit3.requestFocus();
                    return;
                }
