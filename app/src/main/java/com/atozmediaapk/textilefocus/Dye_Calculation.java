...
public class Dye_Calculation extends AppCompatActivity {
   /* private InterstitialAd mInterstitialAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dye_calculation);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Your Fabric Weight");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Your Shade Percentage");
                    edit2.requestFocus();
                    return;
                }
                ...
                if(string3.equals("")){
                    ...
                    edit3.setError("Please Enter Your Percentage of Stock Solution");
                    edit3.requestFocus();
                    return;
                }
                ...
                double btn_calculation2 = btn_calculation1/edt3;
