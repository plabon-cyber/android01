...
public class Courseperinch extends AppCompatActivity {

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_courseperinch);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float btn_calculation2 = (float) (1.82/sqrt);
                double btn_calculation3 =  btn_calculation1-btn_calculation2;
                double btn_calculation4 =  25.406/btn_calculation3;
