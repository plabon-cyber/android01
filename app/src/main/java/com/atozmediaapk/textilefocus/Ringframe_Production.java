...
public class Ringframe_Production extends AppCompatActivity {
  ...
  /*  ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ringframe_production);
      ...
      /*  imageView=(ImageView) findViewById(R.id.preimage);
        ...
        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent2=new Intent(Ringframe_Production.this,UpComming.class);
        ...
        listView3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent3=new Intent(Ringframe_Production.this,UpComming.class);
        ...
        listView4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent4=new Intent(Ringframe_Production.this,UpComming.class);
        ...
        listView5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent5=new Intent(Ringframe_Production.this,UpComming.class);
        ...
        listView6.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent6=new Intent(Ringframe_Production.this,UpComming.class);
        ...
        listView7.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent7=new Intent(Ringframe_Production.this,UpComming.class);
        ...
        listView8.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent8=new Intent(Ringframe_Production.this,UpComming.class);
        ...
        listView9.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent9=new Intent(Ringframe_Production.this,UpComming.class);
        ...
        listView10.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent10=new Intent(Ringframe_Production.this,UpComming.class);
