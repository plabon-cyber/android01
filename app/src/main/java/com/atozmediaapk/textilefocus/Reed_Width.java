...
public class Reed_Width extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reed_width);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Cloth Width");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Crimp%");
                    edit2.requestFocus();
                    return;
                }
                ...
                double btn_calculation1 =  100+edt2;
                double btn_calculation2= (float) ((float) edt1*btn_calculation1);
