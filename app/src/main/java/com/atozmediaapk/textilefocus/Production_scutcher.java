...
public class Production_scutcher extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_production_scutcher);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter weight per lap");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter minutes");
                    edit2.requestFocus();
                    return;
                }
                ...
                double btn_calculation1 =  edt1*60*8;
                double btn_calculation2= (float) (btn_calculation1/ (double) edt2);
