...
public class Weft_Cover_Factor extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_weft_cover_factor);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter PPI");
                    edit1.requestFocus();
                    return;
                }
                ...
                float btn_calculation1=(float) edt1/sqrt;
