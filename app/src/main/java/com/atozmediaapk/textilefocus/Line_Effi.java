...
public class Line_Effi extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_line_effi);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Line Output");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Garment SAM");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){

                    edit3.setError("Please Enter Number of Operators");
                    edit3.requestFocus();
                    return;
                }
                ...
                if(string4.equals("")){
                    ...
                    edit4.setError("Please Enter Shift Hours");
                    edit4.requestFocus();
                    return;
                }
                ...
                float btn_calculation1=edt1*edt2*100;
                float btn_calculation2=edt3*edt4*60;
