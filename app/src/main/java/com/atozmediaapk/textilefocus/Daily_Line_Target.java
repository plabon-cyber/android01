...
public class Daily_Line_Target extends AppCompatActivity {
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Shift Hours");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter No.of Operator working in a line");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){

                    edit3.setError("Please Enter Line Efficiency");
                    edit3.requestFocus();
                    return;
                }
                ...
                if(string4.equals("")){
                    ...
                    edit4.setError("Please Enter Garments SAM");
                    edit4.requestFocus();
                    return;
                }
                ...
                float btn_calculation1=edt1*edt2*edt3*60;
                float btn_calculation2=btn_calculation1/edt4;
                float btn_calculation3=btn_calculation2/100;
