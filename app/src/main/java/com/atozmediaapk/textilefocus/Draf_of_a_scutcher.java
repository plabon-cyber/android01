...
public class Draf_of_a_scutcher extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_draf_of_ascutcher);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter lap roller");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter regulating roller");
                    edit2.requestFocus();
                    return;
                }
