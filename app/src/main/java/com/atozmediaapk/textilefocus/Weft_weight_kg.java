...
public class Weft_weight_kg extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_weft_weight_kg);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter R.S in centimetre");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter length in mtr");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){
                ...
                float btn_calculation1= (float) (edt1*edt2*edt3);
                double btn_calculation2= (float) (4301.14*edt4);
