...
public class Cloth_Cover_Factor extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cloth_cover_factor);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Warp Count");
                    edit2.requestFocus();
                    return;
                }
                if(string3.equals("")){

                    edit3.setError("Please Enter PPI");
                    edit3.requestFocus();
                    return;
                }
                ...
                if(string4.equals("")){
                    ...
                    edit4.setError("Please Enter Weft Count");
                    edit4.requestFocus();
                    return;
                }
                ...
                float btn_calculation1=(float) edt1/sqrt1;

                float edt3 = Float.parseFloat(edit3.getText().toString());
                float sqrt2 = (float) Math.sqrt(Float.parseFloat(edit4.getText().toString()));
                float btn_calculation2=(float) edt3/sqrt2;

                float btn_calculation3=btn_calculation1+btn_calculation2;
                float btn_calculation4=btn_calculation1*btn_calculation2;
                float btn_calculation5=btn_calculation4/28;
                float btn_calculation6=btn_calculation3-btn_calculation5;


                tex1.setText(Float.toString((float) btn_calculation6));
