...
public class Batt_Weight extends AppCompatActivity {
   /* private InterstitialAd mInterstitialAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batt_weight);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Number of Fiber in Cross Section");
                    edit1.requestFocus();
                    return;
                }
                ...
                float btn_calculation2=btn_calculation1/25400;
