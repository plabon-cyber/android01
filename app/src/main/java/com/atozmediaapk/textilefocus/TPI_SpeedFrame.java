...
public class TPI_SpeedFrame extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tpi_speed_frame);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(string1.equals("")){
                    ...
                    edit1.setError("Please Enter Spindle speed(rpm)");
                    edit1.requestFocus();
                    return;
                }
                ...
                if(string2.equals("")){
                    ...
                    edit2.setError("Please Enter Front Roller Delivery(Inch/Min)");
                    edit2.requestFocus();
                    return;
                }
                ...
                float btn_calculation1= (float) ((float) edt1/edt2);
