...
public class Comber_Production extends AppCompatActivity {
   /* private InterstitialAd mInterstitialAd;
    ...
    ListView listView2,listView3,listView4,listView5,listView6;
    String [] listviewitems2=new String[]{"1. Comber Production"};
    String [] listviewitems3=new String[]{"2. Lap Former Production"};
    String [] listviewitems4=new String[]{"3. Batt Weight"};
    String [] listviewitems5=new String[]{"4. Number of fiber in Cross Section"};
    String [] listviewitems6=new String[]{"5. Comber Drafting Total Draft"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comber_production);
       ...
       /* MobileAds.initialize(this, new OnInitializationCompleteListener() {
        ...
        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent2=new Intent(Comber_Production.this,ComberProduction.class);
        ...
        listView3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent3=new Intent(Comber_Production.this,Lap_Former_Proction.class);
        ...
        listView4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent4=new Intent(Comber_Production.this,Batt_Weight.class);
        ...
        listView5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent5=new Intent(Comber_Production.this,Nuber_Fiber.class);
        ...
        listView6.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent6=new Intent(Comber_Production.this,Comber_Drafting.class);
